...
const tripzSchema= new mongoose.Schema({
    ...
    duration:{type:String, required:true, minlength:1, maxlength:10},
    rate:{type:String, required:true, minlength:0, maxlength:1},
    price:{type:String, required:true, minlength:3, maxlength:5}
